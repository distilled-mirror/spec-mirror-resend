...
1. [Setup DMARC](/docs/dashboard/domains/dmarc) for your domain
2. [Setup BIMI](/docs/dashboard/domains/bimi) for your domain
...
1. Provide a clear way to opt out of your emails (including the [Unsubscribe Headers](https://resend.com/docs/dashboard/emails/add-unsubscribe-to-transactional-emails))
...
It can also be helpful to segment your sending by sending address to give Gmail more indication of what type of sending you are doing. This allows Gmail to place your emails in the correct inbox tab (for example, Primary or Promotions).
