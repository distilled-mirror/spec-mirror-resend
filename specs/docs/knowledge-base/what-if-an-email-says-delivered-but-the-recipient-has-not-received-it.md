...
As a result, even though most legitimate emails land in the intended inboxes, your message might end up in the spam/junk folder or, in rare cases, be deleted.
...
* [Configure DMARC](/docs/dashboard/domains/dmarc) to build trust with the inbox provider
